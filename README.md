...
## 📈 GitHub Stats
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=hackerbubai007&layout=compact&theme=dark&hide=html,css,JavaScript)

## 📝 Recent Blog Posts
<!-- BLOG-POST-LIST:START -->
- [Optimizing Spring Boot Applications for Kubernetes](https://yourblog.example/spring-k8s)
- [Event-Driven Architecture with Kafka and Spring](https://yourblog.example/kafka-spring)
<!-- BLOG-POST-LIST:END -->
